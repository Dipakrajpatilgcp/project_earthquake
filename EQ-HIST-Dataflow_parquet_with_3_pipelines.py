...
SERVICE_ACCOUNT_KEY = r"/tmp/default_compute_key.json"
PROJECT_ID = "project-dipakraj1"
GCS_BUCKET = "earthquake-project-bucket-dipakraj"
DATASET_ID = "earthquake_db"
TABLE_ID = "EQ_Dataflow"
...
DATAFLOW_LANDING_LOCATION = f"dataflow_bronz/landing_hist/{c_date}/raw_{c_date}.json"
DATAFLOW_SILVER_LAYER_PATH = f"dataflow_silver/silver_hist/{c_date}/transformed_{c_date}"
